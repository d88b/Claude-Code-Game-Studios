...
var audio_clip_home: AudioStream
var audio_clip_play: AudioStream

var bg_music: Dictionary = {}

func _ready():
	process_mode = Node.PROCESS_MODE_ALWAYS

	audio_clip_home = load("res://assets/Sounds/fantasy_home_bg.mp3")
	audio_clip_play = load("res://assets/Sounds/drums_battle.mp3")
	bg_music = {"home_scene": audio_clip_home, "play_scene": audio_clip_play}
...
func play(clip_config, global_pos = Vector2.INF):
